...
static const int64 MAX_MONEY = 1050000000 * COIN; // MarsBux: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1.5) / 250; // MarsBux: Priority cutoff is 2 MarsBux day / 250 bytes.
    }
